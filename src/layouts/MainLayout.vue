<template>
  ...
  >
    <q-header
      class="tw-bg-transparent tw-p-3 tw-flex l:tw-hidden tw-items-center tw-justify-between"
    >
      <button
        class="tw-bg-gray-second tw-w-[32px] tw-h-[32px] tw-rounded-full tw-grid tw-place-content-center"
        v-ripple
        @click="sidebar = true"
      >
        <svg
    ...
    <q-drawer class="sidebar" show-if-above v-model="sidebar">
      <div class="tw-flex tw-items-center tw-justify-between tw-p-3">
        ...
        <div class="l:tw-hidden">
          <button
            class="tw-bg-white tw-w-[32px] tw-h-[32px] tw-rounded-full tw-grid tw-place-content-center"
            v-ripple
            @click="sidebar = false"
          >
            <svg
    ...
    <q-page-container>
      <div class="tw-hidden l:tw-block tw-relative">
      ...
      <router-view class="tw-flex-grow tw-p-3 l:tw-p-7.5" />
    </q-page-container>
  </q-layout>
</template>
