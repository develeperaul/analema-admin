...
.input-code {
  ...
  @apply tw-rounded-md   tw-text-2xl   tw-font-bold tw-text-center tw-w-10 tw-h-12.5 focus:tw-border-red-600;
  @apply focus:tw-outline-none focus:tw-border-green-500;
  &-block {
